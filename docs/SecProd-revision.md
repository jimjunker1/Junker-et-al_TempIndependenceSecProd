...
### Main Take-aways
- 2$^\circ$ Production scales with GPP, but there are important deviations
...
Here are the temporal patterns between GPP, chlorophyll *a* , and 2$^\circ$ production and their bivariate relationships. Take note GPP is in grams and is 2$^\circ$ production milligrams in the first figure of patterns over time.
...
### Main takeaways
- Supports temperature independence across streams
- Incorporating chlorophyll *a* leads to unrealistically high values
...
This suggests an unaccounted for temperature-dependence of 1.9 eV.
...
## GPP ~ Secondary production{#morin_annual}

### Main takeaways
- support for annual temp dependence.

![](C:/Users/james/Documents/Projects/Junker-et-al_TempIndependenceSecProd/docs/SecProd-revision_files/figure-html/gpp-secprod-1.png)<!-- -->![](C:/Users/james/Documents/Projects/Junker-et-al_TempIndependenceSecProd/docs/SecProd-revision_files/figure-html/gpp-secprod-2.png)<!-- -->
